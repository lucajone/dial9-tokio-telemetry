...
## [0.3.12](https://github.com/lucajone/dial9-tokio-telemetry/compare/dial9-tokio-telemetry-v0.3.11...dial9-tokio-telemetry-v0.3.12) - 2026-05-27

### Added

- Analysis toolkit for memory profiling [stacked] ([#443](https://github.com/lucajone/dial9-tokio-telemetry/pull/443))
- add `Dial9Allocator`, a profiling allocator that feeds events into dial9 traces ([#442](https://github.com/lucajone/dial9-tokio-telemetry/pull/442))

### Other

- add Deserialize impl for dial9-trace-format ([#447](https://github.com/lucajone/dial9-tokio-telemetry/pull/447))
- allow empty prefix when searching buckets
